      ...
      <div className="flex flex-wrap">
        <div className="p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500 ">
            ...
            <img className="h-64 w-96" src={searsYserway} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> 00013521@uca.edu.sv </h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <div className="px-6 py-4">
              ...
              <div className="font-bold text-xl mb-2">calculadora cientifica</div>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $45</h3>
              </div>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> 00014620@uca.edu.sv </h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <div className="px-6 py-4">
              ...
              <div className="font-bold text-xl mb-2">Libro de avm escapini</div>

              <p className=" text-white text-base p-2">
              Libro para algerba vectorial y matrices por ing escapini (recomendado en plan de catedra)
              </p>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $70</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <div className="px-6 py-4">
              ...
              <p className=" text-white text-base p-2">
              Reglas para Dibujo técnico o arquitectura. Casi nuevas poco uso
              </p>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $20</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={calcu} alt="foto" />
          ...
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $55</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={giss} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> depende del pedido</h3>
              </div>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> 00377822@uca.edu.sv </h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={reglat} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $7</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={ti} alt="foto" />
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={audifonos} alt="foto" />

            <div className="px-6 py-4">


              <div className="font-bold text-xl mb-2">Audifonos inalámbricos HUAWEI</div>

              <p className=" text-white text-base p-2">
              Tienen cancelación de sonido decente, en la biblio no se escucha casi nada
              </p>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $30</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={japan} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> acepto libros de ingles avanzado</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={calcuti} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $80</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={guty} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1">depende del diseño</h3>
              </div>
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> 00012922@uca.edu.sv </h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={calculo2} alt="foto" />
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={h} alt="foto" />

            <div className="px-6 py-4">


              <div className="font-bold text-xl mb-2">Libro de analisis historico</div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={gabacha} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $40</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={multi} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $60</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={laptop} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $700</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={lapices} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <p className=" text-white text-base p-2">
                paquete de lapices nuevos perfectos para dibujo arquitectonico.
              </p>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={avmold} alt="foto" />
            ...
            <div className="px-6 py-4">
              ...
              <div className="flex flex-wrap">
                ...
                <h3 className= "text-white text-base align-items-center p-1"> $5</h3>
              </div>
        ...
        <div className=" p-5 authButtons flex flex-wrap space-x-6 space-y-6 items-center justify-center rounded-sm">
          <div className="max-w-sm m-4 rounded-3xl overflow-hidden shadow-lg cursor-pointer bg-slate-500">
            ...
            <img className="h-64 w-96" src={fisica} alt="foto" />
